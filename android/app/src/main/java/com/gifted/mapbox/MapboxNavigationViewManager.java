...
public class MapboxNavigationViewManager extends SimpleViewManager<FrameLayout>
    ...
    public void navigate() {
        ...
        NavigationRoute.builder(context).accessToken(context.getString(R.string.mapbox_access_token)).origin(origin)
        ...
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            ...
            public void run() {
                NavigationLauncherOptions options = NavigationLauncherOptions.builder()
                        .directionsRoute(response.body().routes().get(0)).build();
